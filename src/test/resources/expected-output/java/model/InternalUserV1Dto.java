...
@Schema(name = "InternalUserV1", description = "Internal user of the web shop")
public record InternalUserV1Dto (
    ...
    @Schema(description = "Indicates if mobile number is successfully authenticated using a verification code", required = true)
    @NotNull
    ...
    @Schema(description = "The employee number", required = true)
    @NotBlank
    String employeeNo
) {
